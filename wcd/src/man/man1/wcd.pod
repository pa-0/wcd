...
Replace <PATH> with the location where the wcd executable has been installed.
...
work directory. That is why wcd generates a command script (wcdgo.cmd) which
