...
Replace <PATH> with the location where wcd executable has been installed.
...
In and OS/2 Command Prompt (cmd.exe) an OS/2-program can't change the current work
