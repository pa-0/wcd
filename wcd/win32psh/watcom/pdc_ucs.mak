...
CC      = wcc386
SRCDIR = ..\..\src
DEFINES = -dMSDOS -dWCD_USECURSES -dWCD_WINPWRSH -dWCD_UNICODE -dPDC_WIDE
...
wcdwin32psh.exe: $(OBJS)
	@%create wcd.lnk
	@%append wcd.lnk FIL $(LOBJS)
	@%append wcd.lnk library mpr.lib
	@%append wcd.lnk library pdcursesw.lib
	wlink name wcdwin32psh d all SYS $(TARGET) op inc op m op st=64k op maxe=25 op q op symf @wcd.lnk
	del wcd.lnk
